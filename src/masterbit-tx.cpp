...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MasterBit Core masterbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  masterbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masterbit transaction") + "\n" +
              "  masterbit-tx [options] -create [commands]   " + _("Create hex-encoded masterbit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masterbit transaction
