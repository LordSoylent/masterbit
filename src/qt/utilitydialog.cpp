    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MasterBit Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MasterBit Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  masterbit-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MasterBit in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MBC, 0.1 MBC, 1 MBC and 10 MBC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://masterbitcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://masterbitcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MasterBit Core is shutting down...") + "<br /><br />" +
