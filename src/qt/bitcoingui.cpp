    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MasterBit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MasterBit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and masterbit: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MasterBit Core"), this);
    aboutAction->setStatusTip(tr("Show information about MasterBit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasterBit Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MasterBit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MasterBit addresses"));
    ...
    openAction->setStatusTip(tr("Open a masterbit: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MasterBit Core help message to get a list with possible MasterBit Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MasterBit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterBit network", "", count));
}
...
{
    QString strTitle = tr("MasterBit Core"); // default title
    ...
    // Append title to "MasterBit Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
