...
{
    if(fLiteMode) return; // ignore all MasterBit related functionality
...
/*
    ...
    allow endless transaction that would bloat MasterBit and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("masterbit-privatesend");
