...
2. run masterbitd with -printalert or -sendalert like this:
   /path/to/masterbitd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.masterbit.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MasterBit Core:0.12.0.58/"));
