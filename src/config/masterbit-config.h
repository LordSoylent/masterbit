/* src/config/masterbit-config.h.  Generated from masterbit-config.h.in by configure.  */
/* src/config/masterbit-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/masterbitcoin/masterbit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MasterBit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MasterBit Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "masterbitcore"
