 ...
 *
 *   // network
 *   CMasterBitNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.masterbit.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMasterBitNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMasterBitNetwork(UniValue objIn)
    {
...
// // can be under: MasterBitNetwork
// //   -- signature requirements : Key1(User)
// class CMasterBitNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == MasterBitNetwork);
//     // }
