...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MasterBitNetwork") type = MasterBitNetwork;
    if(strType == "MasterBitNetworkVariable") type = MasterBitNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MasterBitNetwork) s = "MasterBitNetwork";
    if(type == MasterBitNetworkVariable) s = "MasterBitNetworkVariable";
