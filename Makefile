...
pkgdatadir = $(datadir)/masterbitcore
pkgincludedir = $(includedir)/masterbitcore
pkglibdir = $(libdir)/masterbitcore
pkglibexecdir = $(libexecdir)/masterbitcore
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/masterbit-config.h.in \
...
CONFIG_HEADER = $(top_builddir)/src/config/masterbit-config.h
...
ACLOCAL = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/mbc/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/mbc/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/mbc/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/mbc/build-aux/missing automake-1.14
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/mbc/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = masterbitcore
PACKAGE_BUGREPORT = https://github.com/masterbitcoin/masterbit/issues
PACKAGE_NAME = MasterBit Core
PACKAGE_STRING = MasterBit Core 0.12.1
PACKAGE_TARNAME = masterbitcore
PACKAGE_URL = 
...
ZMQ_CFLAGS =  
ZMQ_LIBS = -lzmq  
abs_builddir = /home/ryseek/Desktop/Shared/Home/newCoin/mbc
abs_srcdir = /home/ryseek/Desktop/Shared/Home/newCoin/mbc
abs_top_builddir = /home/ryseek/Desktop/Shared/Home/newCoin/mbc
abs_top_srcdir = /home/ryseek/Desktop/Shared/Home/newCoin/mbc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/mbc/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/masterbitd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/masterbit-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/masterbit-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = MasterBit-Qt.app
OSX_DMG = MasterBit-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_masterbit_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_masterbit_coverage.info test_masterbit.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MasterBit-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/masterbit-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/masterbit-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/masterbit-config.h
$(top_srcdir)/src/config/masterbit-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/masterbit-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/MasterBit-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MasterBit-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "MasterBit-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MasterBit-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_masterbit.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_masterbit -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_masterbit_filtered.info: test_masterbit.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_masterbit_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_masterbit_filtered.info
...
#test_masterbit_coverage.info: baseline_filtered_combined.info test_masterbit_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_masterbit_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_masterbit_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_masterbit_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_masterbit.coverage/.dirstamp:  test_masterbit_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_masterbit.coverage/.dirstamp total.coverage/.dirstamp

# MasterBit: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_masterbit.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
