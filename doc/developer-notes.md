...
MasterBit Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as MasterBit Core, where everyone uses
...
pay attention to for reviewers of MasterBit Core code.

General MasterBit Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: MasterBit Core uses tinyformat, which is type safe. Leave them out to avoid confusion
