...
This mechanism has been integrated into Bitcore-Node-MasterBit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/masterbitcoin/insight-api-masterbit#web-socket-api](https://github.com/masterbitcoin/insight-api-masterbit#web-socket-api) 
* API: [https://github.com/masterbitcoin/insight-api-masterbit#instantsend-transactions](https://github.com/masterbitcoin/insight-api-masterbit#instantsend-transactions) 
...
By default, the MasterBit Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MasterBit Core daemon:
