...
Only requiring some minor changes is masterbit.cpp.
...
Changes to masterbit.cpp
----------------------
masterbit.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
